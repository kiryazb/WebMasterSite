...
from api.actions.queries import _get_urls_with_pagination_and_like_query, _get_urls_with_pagination_and_like_sort_query, \
    ...
    while True:
        ...
        for el in grouped_data:
            ...
            if impressions > 0:
                ...
                info["Result"] = [0, total_cllicks, impressions, 0]
            res.append(el[0])
            for el in main_header:
                if el in info:
                    res.extend(info[el])
